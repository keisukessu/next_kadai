        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-1">
                <label htmlFor="password" className="block text-sm font-medium">
                    新しいパスワード
                    <span className="text-gray-600 text-xs ml-2">（変更しない場合は空欄）</span>
                </label>
                <div className="relative">
                    <input
                        ...
                        className="w-full px-3 py-2 border border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-black pr-10 placeholder:text-xs bg-white"
                    />
                    <button
                        type="button"
            ...
            <div className="space-y-1">
                ...
                <div className="relative">
                    <input
                        ...
                        className="w-full px-3 py-2 border border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-black bg-white pr-10 placeholder:text-xs"
                    />
                    <button
                        type="button"
